...
| --------------- | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `01_anatomy.py` | `source_reconstruction.ipynb`                                                       | Defining source locations for surface (and optionally volumetric) source space, and computing the morph to `fsaverage`.          |
| `02_forward.py` | `source_reconstruction.ipynb`                                                       | Creating the forward model for surface (and optionally volumetric) source space.                                                 |
